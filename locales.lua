...
L.NormalMountsTooltip = "When enabled, only summon ground/flying mounts marked as favorites will be summoned."
L.SwimmingMounts = "Swimming Mounts"
L.SwimmingMountsTooltip = "When enabled, only summon swimming mounts marked as favorites will be summoned."
L.PassengerMounts = "Passenger Mounts (Ground & Flying)"
L.PassengerMountsTooltip = "When enabled, only summon passenger mounts marked as favorites will be summoned."
L.VendorMounts = "Vendor Mounts"
L.VendorMountsTooltip = "When enabled, only summon vendor mounts marked as favorites will be summoned."
