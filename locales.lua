...
L.OutOfDate = "There is an update available for |cff%1$s%2$s|r!" -- ravMounts.color, ravMounts.name
L.Install = "Thanks for installing |cff%1$s%2$s|r!" -- ravMounts.color, ravMounts.name
